...
func TestFnArg3(t *testing.T) {
	...
	t.Run("FnArg3 P1 Case", func(t *testing.T) {
		r1 := FnArg3[int, int, int, int](sum).P1(1)(2, 3)
		assert.Equal(t, sum(1, 2, 3), r1)

		r2 := FnArg3[int, int, int, int](sum).P1(1).P1(2)(3)
...
func TestFnArg4(t *testing.T) {
	...
	t.Run("FnArg4 P1 Case", func(t *testing.T) {
		r1 := FnArg4[int, int, int, int, int](sum).P1(1)(2, 3, 4)
		assert.Equal(t, sum(1, 2, 3, 4), r1)

		r2 := FnArg4[int, int, int, int, int](sum).P1(1).P1(2)(3, 4)
		assert.Equal(t, sum(1, 2, 3, 4), r2)

		r3 := FnArg4[int, int, int, int, int](sum).P1(1).P1(2).P1(3)(4)
		assert.Equal(t, sum(1, 2, 3, 4), r3)

		r4 := FnArg4[int, int, int, int, int](sum).P1(1).P2(2, 3)(4)
		assert.Equal(t, sum(1, 2, 3, 4), r4)
	})

	t.Run("FnArg4 P2 Case", func(t *testing.T) {
		r1 := FnArg4[int, int, int, int, int](sum).P2(1, 2)(3, 4)
		assert.Equal(t, sum(1, 2, 3, 4), r1)

		r2 := FnArg4[int, int, int, int, int](sum).P2(1, 2).P1(3)(4)
		assert.Equal(t, sum(1, 2, 3, 4), r2)
	})
...
func TestFnArg5(t *testing.T) {
	...
	t.Run("FnArg5 P1 Case", func(t *testing.T) {
		r1 := FnArg5[int, int, int, int, int, int](sum).P1(1)(2, 3, 4, 5)
		assert.Equal(t, sum(1, 2, 3, 4, 5), r1)

		r2 := FnArg5[int, int, int, int, int, int](sum).P1(1).P1(2)(3, 4, 5)
		assert.Equal(t, sum(1, 2, 3, 4, 5), r2)

		r3 := FnArg5[int, int, int, int, int, int](sum).P1(1).P1(2).P1(3)(4, 5)
		assert.Equal(t, sum(1, 2, 3, 4, 5), r3)

		r4 := FnArg5[int, int, int, int, int, int](sum).P1(1).P1(2).P1(3).P1(4)(5)
		assert.Equal(t, sum(1, 2, 3, 4, 5), r4)

		r5 := FnArg5[int, int, int, int, int, int](sum).P1(1).P2(2, 3)(4, 5)
		assert.Equal(t, sum(1, 2, 3, 4, 5), r5)

		r6 := FnArg5[int, int, int, int, int, int](sum).P1(1).P2(2, 3).P1(4)(5)
		assert.Equal(t, sum(1, 2, 3, 4, 5), r6)

		r7 := FnArg5[int, int, int, int, int, int](sum).P1(1).P3(2, 3, 4)(5)
		assert.Equal(t, sum(1, 2, 3, 4, 5), r7)

		r8 := FnArg5[int, int, int, int, int, int](sum).P1(1).P1(2).P2(3, 4)(5)
		assert.Equal(t, sum(1, 2, 3, 4, 5), r8)
	})

	t.Run("FnArg5 P2 Case", func(t *testing.T) {
		r1 := FnArg5[int, int, int, int, int, int](sum).P2(1, 2)(3, 4, 5)
		assert.Equal(t, sum(1, 2, 3, 4, 5), r1)

		r2 := FnArg5[int, int, int, int, int, int](sum).P2(1, 2).P2(3, 4)(5)
		assert.Equal(t, sum(1, 2, 3, 4, 5), r2)

		r3 := FnArg5[int, int, int, int, int, int](sum).P2(1, 2).P1(3).P1(4)(5)
		assert.Equal(t, sum(1, 2, 3, 4, 5), r3)

		r4 := FnArg5[int, int, int, int, int, int](sum).P2(1, 2).P1(3)(4, 5)
		assert.Equal(t, sum(1, 2, 3, 4, 5), r4)
	})

	t.Run("FnArg5 P3 Case", func(t *testing.T) {
		r1 := FnArg5[int, int, int, int, int, int](sum).P3(1, 2, 3)(4, 5)
		assert.Equal(t, sum(1, 2, 3, 4, 5), r1)

		r2 := FnArg5[int, int, int, int, int, int](sum).P3(1, 2, 3).P1(4)(5)
		assert.Equal(t, sum(1, 2, 3, 4, 5), r2)
	})
